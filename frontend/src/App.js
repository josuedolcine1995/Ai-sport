      ...
      <div className="max-w-4xl mx-auto px-4 pb-8">
        ...
        <div className="mt-12 grid md:grid-cols-3 gap-6">
          <div className="bg-white/5 backdrop-blur-lg rounded-xl border border-white/10 p-6">
            ...
            <h3 className="text-white font-semibold mb-2">Player Analytics</h3>
            <p className="text-gray-300 text-sm">Deep statistical analysis of player performance, trends, and predictions</p>
          </div>
          ...
          <div className="bg-white/5 backdrop-blur-lg rounded-xl border border-white/10 p-6">
            ...
            <h3 className="text-white font-semibold mb-2">Smart Betting</h3>
            <p className="text-gray-300 text-sm">AI-powered recommendations for spreads, over/unders, and moneylines</p>
          </div>
          ...
          <div className="bg-white/5 backdrop-blur-lg rounded-xl border border-white/10 p-6">
            ...
            <h3 className="text-white font-semibold mb-2">DFS Lineups</h3>
            <p className="text-gray-300 text-sm">Optimized lineups for FanDuel, DraftKings, and other fantasy platforms</p>
          </div>
        </div>
      </div>
    </div>
